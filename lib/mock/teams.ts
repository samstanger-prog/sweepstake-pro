...
export const MOCK_TEAMS = [
  ...
  { name: "Belgium", code: "BEL", flag_emoji: "🇧🇪", pot: "B" as const, seed: 9, group_name: "E" },
  { name: "Croatia", code: "CRO", flag_emoji: "🇭🇷", pot: "B" as const, seed: 10, group_name: "E" },
  { name: "Italy", code: "ITA", flag_emoji: "🇮🇹", pot: "B" as const, seed: 11, group_name: "F" },
  { name: "Uruguay", code: "URU", flag_emoji: "🇺🇾", pot: "B" as const, seed: 12, group_name: "F" },
